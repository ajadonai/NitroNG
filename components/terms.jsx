...
function TermsInner(){
  ...
  const sections=[
    ...
    ["Payments, wallet and refunds","All payments are processed in Nigerian Naira (₦) through our supported payment gateways. Money you add to your wallet is credit for Nitro services. It does not expire, and it is spent on Nitro rather than paid back to a bank account. When an order is undelivered or cancelled, the refund is credited to your Nitro wallet, not to your original payment method, unless otherwise required by law. We reserve the right to modify service pricing at any time without prior notice."],
  ...
  return <LegalLayout label={tr("Legal")} title={tr("Terms of service")} date="September 14, 2026" summary={summary} sections={sections} related={related} action="back"/>;
}

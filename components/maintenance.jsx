...
function MaintenanceInner() {
  ...
  return (
    <div className="min-h-dvh flex flex-col relative overflow-hidden" style={{ background: bg, fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif" }}>
      ...
      {/* Nav */}
      <nav className="flex items-center justify-center px-6 h-[52px] backdrop-blur-[20px] relative z-10 shrink-0" style={{ borderBottom: `1px solid ${border}`, background: dark ? "rgba(8,11,20,.6)" : "rgba(244,241,237,.7)" }}>
      ...
      <div className="flex-1 flex items-center justify-center relative z-[1] px-5 py-12">
        <div className="text-center w-full max-w-[560px] relative">
          ...
          <div className="mx-rise inline-flex text-[11px] font-bold tracking-[2.6px]" style={{ color: amber, fontFamily: "'JetBrains Mono',monospace" }}>{tr("SCHEDULED MAINTENANCE")}</div>
          ...
          <h1 className="mx-h1 mx-rise" style={{ color: text, animationDelay: ".2s" }}>{tr("Quick tune-up.")}</h1>
          ...
          <div className="mx-steps mx-rise" style={{ animationDelay: ".36s" }}>
            <span className="mx-s" style={{ color: green }}><span className="mx-pd" />{tr("Backup complete")}</span>
            <span className="mx-conn" style={{ width: 22, height: 1, background: hair }} />
            <span className="mx-s mx-act" style={{ color: amber }}><span className="mx-pd" />{tr("Upgrading now")}</span>
            <span className="mx-conn" style={{ width: 22, height: 1, background: hair }} />
            <span className="mx-s" style={{ color: muted }}><span className="mx-pd" />{tr("Final checks")}</span>
          </div>
          ...
          <div className="mx-rise" style={{ animationDelay: ".44s" }}>
            <div className="inline-flex flex-col items-center gap-1 mt-6 rounded-2xl py-4 px-[30px]" style={{ background: card, border: `1px solid ${hair}` }}>
              <span className="text-[11px] font-extrabold uppercase" style={{ color: muted, letterSpacing: "1.6px" }}>{tr("Back in about")}</span>
          ...
          <div className="mx-ctas mx-rise" style={{ animationDelay: ".52s" }}>
            <WaButton href={`https://wa.me/${waNum}`} weight="quiet" className="pill">{tr("Updates on WhatsApp")}</WaButton>
            <button onClick={() => window.location.reload()} className="inline-flex items-center gap-2 text-[13px] font-bold py-[11px] px-[18px] rounded-full cursor-pointer transition-transform duration-150 hover:-translate-y-px" style={{ color: soft, background: card, border: `1px solid ${border}` }}>{tr("Try again")}</button>
          </div>

          <div className="mx-rise flex items-center justify-center gap-2 mt-[22px]" style={{ animationDelay: ".6s" }}>
            <span className="text-xs mr-1" style={{ color: muted }}>{tr("Stay updated")}</span>
          ...
          <div className="mx-rise text-[11px] mt-4" style={{ color: muted, animationDelay: ".68s" }}>{tr("This page checks every 15 seconds and brings you back automatically.")}</div>
          ...
          <div className="mx-rise flex items-center justify-center gap-[7px] mt-7 text-[11px]" style={{ color: muted, animationDelay: ".76s" }}>
            ...
            {tr("Planned maintenance. Orders in flight are unaffected.")}
          </div>
        </div>
      </div>
    </div>

  ...
  return (
    <div className="root">
      ...
      <aside className={`sb${sb?" open":""}${mini?" collapsed":""}`}>
        ...
        {mini&&<div style={{padding:"8px 0",borderBottom:`1px solid ${t.surfaceBorder}`,textAlign:"center"}}><div className="m" style={{fontSize:12,fontWeight:700,color:t.green}}>{fN(user.balance)}</div></div>}

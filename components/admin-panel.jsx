...
const MOCK_USERS=[{id:1,name:"Chidi Okafor",email:"chidi@gmail.com",balance:45000,orders:23,spent:156000,joined:"2026-01-15",status:"Active",ref:"NTR-C4K1"},{id:2,name:"Amina Bello",email:"amina@yahoo.com",balance:120500,orders:67,spent:890000,joined:"2025-11-20",status:"Active",ref:"NTR-A8B2"},{id:3,name:"Tunde Adeyemi",email:"tunde@outlook.com",balance:8250,orders:12,spent:64000,joined:"2026-02-28",status:"Active",ref:"NTR-T3A9"},{id:4,name:"Ngozi Eze",email:"ngozi@gmail.com",balance:310000,orders:145,spent:2340000,joined:"2025-09-10",status:"Active",ref:"NTR-N7E5"},{id:5,name:"Segun Akinola",email:"segun@mail.com",balance:0,orders:3,spent:12000,joined:"2026-03-18",status:"Suspended",ref:"NTR-S2A0"},{id:6,name:"Fatima Yusuf",email:"fatima@gmail.com",balance:54000,orders:31,spent:445000,joined:"2025-12-05",status:"Active",ref:"NTR-F1Y6"},{id:7,name:"Emeka Nwankwo",email:"emeka@live.com",balance:22000,orders:18,spent:198000,joined:"2026-01-22",status:"Active",ref:"NTR-E9N3"},{id:8,name:"Blessing Okoro",email:"blessing@gmail.com",balance:87000,orders:42,spent:567000,joined:"2025-10-15",status:"Active",ref:"NTR-B4O8"}];
...
const MOCK_ADMINS=[{id:1,name:"You (Owner)",email:"admin@thenitro.ng",role:"superadmin",lastActive:"2026-03-23T10:30:00",status:"Active"},{id:2,name:"David Ojo",email:"david@thenitro.ng",role:"admin",lastActive:"2026-03-23T09:15:00",status:"Active"},{id:3,name:"Grace Adebayo",email:"grace@thenitro.ng",role:"support",lastActive:"2026-03-22T18:00:00",status:"Active"},{id:4,name:"Ibrahim Musa",email:"ibrahim@thenitro.ng",role:"finance",lastActive:"2026-03-21T14:00:00",status:"Inactive"}];
...
export default function AdminPanel(){
  ...
  <div style={{padding:"16px 14px",borderBottom:`0.5px solid ${t.surfaceBorder}`,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
    <button onClick={()=>window.scrollTo({top:0,behavior:"smooth"})} style={{display:"flex",alignItems:"center",gap:8,background:"none",padding:0,border:"none",outline:"none",cursor:"pointer"}}><div style={{width:30,height:30,borderRadius:8,background:t.logoGrad,display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,color:"#fff"}}>N</div><div><div style={{fontSize:15,fontWeight:600,color:t.text}}>Nitro</div><div style={{fontSize:9,color:t.textMuted,letterSpacing:2,textTransform:"uppercase"}}>Admin Panel</div></div></button>

    ...
    <div className="fixed bottom-0 inset-x-0 z-[9999] p-2.5 sm:px-3.5 animate-[cookieSlideUp_.4s_ease-out]">
      <div
        ...
        style={{
          ...
          borderTop: `1px solid ${dark ? 'rgba(196,125,142,.2)' : 'rgba(163,88,107,.2)'}`,
          borderRight: `1px solid ${dark ? 'rgba(196,125,142,.2)' : 'rgba(163,88,107,.2)'}`,
          borderBottom: `1px solid ${dark ? 'rgba(196,125,142,.2)' : 'rgba(163,88,107,.2)'}`,
      ...
      >
        ...
        <div className="flex gap-2 shrink-0">
          <button
            onClick={decline}
            className="flex-1 sm:flex-none py-[7px] px-[18px] rounded-lg text-xs font-medium cursor-pointer bg-transparent"
            style={{
              color: dark ? 'rgba(255,255,255,.5)' : 'rgba(28,27,25,.55)',
              border: `1px solid ${dark ? 'rgba(255,255,255,.15)' : 'rgba(28,27,25,.18)'}`,
            }}
          >Decline</button>
          <button
            onClick={accept}
            className="flex-1 sm:flex-none py-[7px] px-[18px] rounded-lg text-xs font-medium cursor-pointer bg-accent text-white"
          >Accept</button>
        </div>
      </div>
    </div>

    ...
    <div className="min-h-dvh flex flex-col relative overflow-hidden" style={{ background: bg, fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif" }}>
      ...
      <div className="flex-1 flex items-center justify-center relative z-[1] p-5">
        ...
        <div className="text-center max-w-[520px] relative z-[1]">
          ...
          {/* Buttons — glass card */}
          <div className="inline-flex gap-2.5 justify-center flex-wrap mb-8 py-3.5 px-5 rounded-2xl" style={{ background: dark ? "rgba(255,255,255,.05)" : "rgba(255,255,255,.6)", border: `1px solid ${border}`, backdropFilter: "blur(12px)" }}>
            ...
            <a href="/dashboard" className="py-3 px-[30px] rounded-xl text-[15px] font-semibold no-underline transition-transform duration-200 hover:-translate-y-px" style={{ background: dark ? "rgba(255,255,255,.12)" : "rgba(0,0,0,.05)", color: text, border: `1px solid ${border}` }}>Dashboard</a>
          </div>

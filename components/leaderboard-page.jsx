  ...
  return (
    <>
      ...
      {loading ? (
        ...
        {/* List (rank 4+) */}
        {rest.length > 0 && (
          <div className="rounded-xl overflow-hidden border" style={{ background: dark ? "rgba(255,255,255,.12)" : "rgba(255,255,255,.9)", borderColor: dark ? "rgba(255,255,255,.18)" : "rgba(0,0,0,.18)" }}>

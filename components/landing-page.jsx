        ...
        <section id="hero" className="snap-section overflow-hidden relative flex flex-col" style={{background:t.heroBg}}>
          ...
          <div className={`flex items-center justify-center gap-12 max-desktop:gap-0 pt-14 pb-10 max-desktop:pt-6 max-desktop:pb-4 max-md:pb-2 px-[60px] max-desktop:px-10 max-md:px-5 max-w-[1200px] mx-auto w-full relative z-[1] flex-1 max-desktop:flex-col max-desktop:text-center max-desktop:min-h-0 ${siteAlerts.length > 0 ? "max-md:pt-[50px]" : "max-md:pt-2"}`}>
            ...
            <div className="flex-1 max-w-[540px] text-left relative z-[1] max-desktop:flex-none max-desktop:text-center max-desktop:max-w-full max-desktop:flex max-desktop:flex-col max-desktop:items-center">
              <h1 className="fu fd1 text-[52px] max-desktop:text-[48px] max-md:text-[28px] font-semibold leading-[1.05] -tracking-[1.5px] mb-2 max-md:mb-1.5" style={{color:t.heroText}}>Your social media deserves <span className="max-md:hidden"><br/></span><span className="serif italic font-medium text-[58px] max-desktop:text-[54px] max-md:text-[28px] hero-shimmer" style={{color:dark?t.accent:"#fff",textShadow:dark?"none":"0 2px 20px rgba(0,0,0,.15)"}}>better numbers.</span></h1>
              ...
              <div className="fu fd3 hidden max-md:!flex items-center justify-center gap-[7px] mb-4">
                {[
                  ...
                  [<svg width="14" height="10" viewBox="0 0 576 512" fill="#FF0000"><path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"/></svg>,"rgba(255,0,0,.1)"],
                  [<svg width="12" height="12" viewBox="0 0 24 24" fill={dark?"#eee":"#fff"}><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,dark?"rgba(255,255,255,.1)":"rgba(255,255,255,.2)"],

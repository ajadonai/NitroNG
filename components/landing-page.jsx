...
function LandingInner(){
  ...
  return(
    <div className="root" suppressHydrationWarning style={{height:"100dvh",overflow:"hidden",display:"flex",flexDirection:"column"}}>
      ...
      <nav className="main-nav" style={{display:"flex",alignItems:"center",justifyContent:"space-between",height:60,background:dark?"#060810":scrolled?"rgba(139,74,94,.98)":"rgba(163,88,107,.95)",borderBottom:`1px solid ${dark?"rgba(255,255,255,.06)":"rgba(255,255,255,.12)"}`,flexShrink:0,zIndex:100,transition:"background 1.2s ease"}}>

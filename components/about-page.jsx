  ...
  return (
    <>
      ...
      <div className="min-h-dvh flex flex-col font-[Plus Jakarta Sans,system-ui,sans-serif]" style={{ background: t.bg }}>
        <SharedNav />
        <main className="flex-1 py-12 px-6 pb-20 max-w-[800px] mx-auto w-full">

          {/* Header */}
          <div className="mb-12">
            <span className="text-xs font-semibold tracking-[2px] uppercase block mb-3" style={{ color: accent }}>About</span>
            <h1 className="text-[clamp(28px,5vw,40px)] font-semibold mb-3 leading-tight" style={{ color: t.text }}>Built in Lagos, <span className="serif italic font-medium text-[clamp(32px,5.5vw,44px)]" style={{ color: accent }}>for Nigeria</span></h1>
            <p className="text-[15px] leading-[1.7] max-w-[560px]" style={{ color: t.textSoft }}>
          ...
          {/* Why Nitro */}
          <section className="mb-10">
            <h2 className="text-lg font-semibold mb-4" style={{ color: t.text }}>Why Nitro exists</h2>
            <p className="text-[14px] leading-[1.75] mb-4" style={{ color: t.textSoft }}>
          ...
          <section className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-10">
            {[
              ...
              <div key={label} className="rounded-xl p-4 text-center" style={{ background: cardBg, border: `1px solid ${border}` }}>
                <div className="text-xl font-bold mb-0.5" style={{ color: accent }}>{num}</div>
                <div className="text-[12px]" style={{ color: t.textMuted }}>{label}</div>
              </div>
            ))}
          </section>
          ...
          {/* Company info */}
          <section className="mb-10">
            <h2 className="text-lg font-semibold mb-4" style={{ color: t.text }}>Company details</h2>
          ...
          {/* How we're different */}
          <section className="mb-10">
            <h2 className="text-lg font-semibold mb-4" style={{ color: t.text }}>How we're different</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={title} className="rounded-xl p-4" style={{ background: softBg, border: `1px solid ${dark ? "rgba(255,255,255,.06)" : "rgba(0,0,0,.04)"}` }}>

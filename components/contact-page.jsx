        ...
        <main className="flex-1 px-6 pb-20 max-w-[700px] mx-auto w-full">
          ...
          {waLink && (
            <div className="rounded-2xl p-8 max-md:p-6 mb-8 text-center" style={{ background: dark ? "rgba(37,211,102,.06)" : "rgba(37,211,102,.04)", border: `1px solid ${dark ? "rgba(37,211,102,.18)" : "rgba(37,211,102,.12)"}` }}>
              ...
              <p className="text-[14px] mb-5 max-w-[400px] mx-auto" style={{ color: t.textSoft }}>Our main support channel. Typical reply time is minutes during Lagos working hours, longer late at night and on Sundays. Send your order ID if your question is about a specific order.</p>
              <a href={waLink} className="inline-flex items-center gap-2 py-3 px-7 rounded-xl text-white text-[14px] font-semibold no-underline transition-[transform,box-shadow] duration-200 hover:-translate-y-px" style={{ background: "#25d366" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
            <div className="rounded-xl p-5" style={{ background: cardBg, border: `1px solid ${border}` }}>
              ...
              <p className="text-[12px] mt-1" style={{ color: t.textMuted }}>Better for anything that needs attachments, invoices or a written record. Replies usually take a few hours rather than minutes.</p>
            </div>
            <div className="rounded-xl p-5" style={{ background: cardBg, border: `1px solid ${border}` }}>
              ...
              <p className="text-[12px] mt-1" style={{ color: t.textMuted }}>On Instagram and X. Fine for general questions. Please do not send order details or account information over social DMs.</p>
            </div>
          </div>
          ...
          <div className="rounded-xl p-5 mb-10" style={{ background: dark ? "rgba(196,125,142,.06)" : "rgba(196,125,142,.04)", border: `1px solid ${dark ? "rgba(196,125,142,.14)" : "rgba(196,125,142,.1)"}` }}>
            <h2 className="text-[14px] font-semibold mb-2" style={{ color: t.text }}>When we are around</h2>
          ...
          <section className="mb-10">
            ...
            <p className="text-[14px] mb-4 leading-[1.6]" style={{ color: t.textSoft }}>Four things come up constantly. If yours is one of them, this will be faster than waiting for a reply.</p>
          ...
          <div className="rounded-xl p-5 mb-10" style={{ background: cardBg, border: `1px solid ${border}` }}>
            <h2 className="text-[14px] font-semibold mb-2" style={{ color: t.text }}>What to include when you message</h2>

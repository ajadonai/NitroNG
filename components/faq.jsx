...
function FAQInner() {
  ...
  const faqs = [
    ...
    ["Are the followers real people?", "We deliver engagement from real, active accounts — not empty bots. The quality depends on the tier you choose: Premium uses higher-quality accounts with profile pictures, posts, and activity. Standard offers a solid middle ground with refill coverage. Budget is the cheapest option but may have lower retention."],
    ...
    ["Do you offer refills?", "Yes. Many services include refill coverage. If you lose followers or engagement after delivery, you can request a refill from your dashboard at no extra cost — as long as it's within the refill window shown on your order."],

...
function FAQInner() {
  ...
  const faqs = [
    ...
    ["How fast is delivery?", "Orders are typically delivered within 0 to 6 hours. In some cases, delivery may take up to 24 hours depending on provider load. We are unable to act on delivery speed requests within the first 6 hours of order placement. You can track progress in real time on your dashboard."],

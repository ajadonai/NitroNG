...
function FAQInner() {
  ...
  const faqs = [
    ...
    ["Are the followers real people?", "We deliver engagement from real, active accounts — not empty bots. The quality depends on the tier you choose: Premium tiers use higher-quality accounts with profile pictures, posts, and activity. Budget tiers are still real accounts but may be less active."],
    ["Will my account get banned?", "No. We never ask for your password or log into your account. All we need is your public profile or post link. Millions of social media users buy engagement without issues — the key is choosing a reputable provider (like Nitro) that delivers gradually from real accounts, not sudden spikes from obvious bots."],
    ...
    ["How much do services cost?", "Prices start as low as ₦20/1,000 for TikTok likes and ₦87/1,000 for Instagram followers. YouTube views start from ₦16/1,000, X followers from ₦109/1,000, and Facebook likes from ₦620/1,000. Every service has Budget, Standard, and Premium tiers — Budget is cheapest, Premium costs more but has higher quality and refill guarantees. Check the pricing page for full details."],
    ...
    ["Do you offer refills?", "Yes. Many of our services include automatic refills. If you lose followers or engagement within the refill period (typically 30 days, depending on the service), we'll top them back up for free."],
    ...
    ["Can I get a cash refund to my bank account?", "Refunds are credited to your Nitro wallet balance, not directly to your bank account or card. This lets us process refunds instantly — no waiting days for bank reversals. Your wallet balance can be used for any future order."],

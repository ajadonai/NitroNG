...
function FAQInner() {
  ...
  const faqs = [
    ...
    ["How fast is delivery?", "Most orders start processing within seconds of payment. Small orders deliver in minutes. Larger orders are spread over several hours for natural growth — you can track progress in real time on your dashboard."],

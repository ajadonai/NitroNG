          ...
          <>
            ...
            {!selected && showQuick && !isLive && <>
              ...
              <div className="desktop:hidden relative shrink-0">
                {quickPopup && <div className="absolute bottom-full left-0 right-0 mb-1 py-2.5 px-3 rounded-xl flex gap-[5px] flex-wrap" style={{ background: dark ? "#161b2e" : "#fff", border: `1px solid ${dark ? "rgba(255,255,255,.18)" : "rgba(0,0,0,.14)"}`, boxShadow: dark ? "0 -8px 24px rgba(0,0,0,.4)" : "0 -8px 24px rgba(0,0,0,.1)" }}>

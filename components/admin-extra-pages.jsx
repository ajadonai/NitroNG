...
.tm-bd{position:fixed;inset:0;z-index:60;background:rgba(0,0,0,.4)-webkit-backdrop-filter:blur(6px);backdrop-filter:blur(6px);}.tm-bd.center{display:flex;align-items:center;justify-content:center;padding:16px}
...
export function AdminCouponsPage({ dark, t }) {
  ...
  const vars = {
    "--card": "var(--t-card-bg)", "--ink": t.text, "--mut": t.textMuted, "--dim": dark ? "#5c6170" : "#a19b93", "--line": t.cardBorder, "--rail": dark ? "rgba(255,255,255,.07)" : "rgba(0,0,0,.06)", "--soft": dark ? "#120c1e" : "#faf9f7",
    "--ac": t.accent, "--acln": dark ? "rgba(196,125,142,.7)" : "rgba(196,125,142,.55)", "--ok": dark ? "#6ee7b7" : "#0a7d54", "--warn": dark ? "#fcd34d" : "#b45309", "--bad": dark ? "#fca5a5" : "#c62828", "--in": dark ? "#160f22" : "#fff",
  };
  return (
...
export function AdminNotificationsPage({ dark, t }) {
  ...
  const vars = {
    "--card": "var(--t-card-bg)", "--ink": t.text, "--mut": t.textMuted, "--dim": dark ? "#5c6170" : "#a19b93", "--line": t.cardBorder, "--rail": dark ? "rgba(255,255,255,.07)" : "rgba(0,0,0,.06)", "--soft": dark ? "#120c1e" : "#faf9f7",
    "--ac": t.accent, "--ok": dark ? "#6ee7b7" : "#0a7d54", "--warn": dark ? "#fcd34d" : "#b45309", "--bad": dark ? "#fca5a5" : "#c62828", "--in": dark ? "#160f22" : "#fff",
  };
  return (
...
export function AdminMaintenancePage({ dark, t }) {
  ...
  const vars = {
    "--card": "var(--t-card-bg)", "--ink": t.text, "--mut": t.textMuted, "--dim": dark ? "#5c6170" : "#a19b93", "--line": t.cardBorder, "--rail": dark ? "rgba(255,255,255,.07)" : "rgba(0,0,0,.06)", "--soft": dark ? "#120c1e" : "#faf9f7", "--bg": t.bg || "var(--t-bg)",
...
.pv-r{display:grid;grid-template-columns:minmax(140px,1.1fr) 92px minmax(0,1.2fr) 100px minmax(120px,1fr) 178px;align-items:center;gap:12px;padding:14px 16px;border-top:1px solid var(--rail)}.pv-r:first-child{border-top:0}
...
.tl-bd{position:fixed;inset:0;z-index:60;background:rgba(0,0,0,.4)-webkit-backdrop-filter:blur(6px);backdrop-filter:blur(6px);}
...
export function AdminChangelogPage({ dark, t }) {
  ...
  const vars = {
    "--card": "var(--t-card-bg)", "--ink": t.text, "--mut": t.textMuted, "--dim": dark ? "#5c6170" : "#a19b93", "--line": t.cardBorder, "--rail": dark ? "rgba(255,255,255,.07)" : "rgba(0,0,0,.06)", "--soft": dark ? "#120c1e" : "#faf9f7",
    "--ac": t.accent, "--acln": dark ? "rgba(196,125,142,.7)" : "rgba(196,125,142,.55)", "--ok": dark ? "#6ee7b7" : "#0a7d54", "--blue": dark ? "#a5b4fc" : "#4c62c4", "--bad": dark ? "#fca5a5" : "#c62828", "--in": dark ? "#160f22" : "#fff",
  };
  return (

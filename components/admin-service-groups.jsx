...
function LinkServiceInline({ tierId, services, dark, t, inputStyle, markupSettings, onLink }) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="max-h-[120px] overflow-y-auto rounded-md" style={{ border: `1px solid ${dark ? "rgba(255,255,255,.16)" : "rgba(0,0,0,.12)"}`, background: dark ? "#131728" : "#fff" }}>
        {filtered.map(s => (
          ...
          {addTierGroup === g.id && (
            <div className="py-4 px-5" style={{ background: dark ? "rgba(196,125,142,.06)" : "rgba(196,125,142,.03)", borderBottom: headerBorder }}>
              ...
              <div className="mb-2.5">
                ...
                {tierSvcSearch && (
                  <div className="max-h-[150px] overflow-y-auto rounded-lg" style={{ border: `1px solid ${dark ? "rgba(255,255,255,.16)" : "rgba(0,0,0,.12)"}`, background: dark ? "#131728" : "#fff" }}>
                    {filteredSvcs.map(s => (

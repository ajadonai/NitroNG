...
function ExpandedOrderDetails({ o, dark, t, doAction, actionLoading, confirm, compact, toast, onNavigate, waNum }) {
  ...
  const reportIssueButton = waNum ? (
    <a href={`https://wa.me/${waNum}?text=${waMessage}`} target="_blank" rel="noopener noreferrer" className="m flex items-center gap-1.5 text-[12px] font-semibold cursor-pointer no-underline border-none rounded-lg py-1.5 px-2.5" style={{ background: dark ? "rgba(37,211,102,.12)" : "rgba(37,211,102,.07)", color: "#25d366" }}>

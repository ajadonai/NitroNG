      ...
      {phase === "welcome" && (
        <div className="fixed z-[101] top-1/2 left-1/2 text-center rounded-2xl pt-7 px-7 pb-6 max-w-[360px] w-[calc(100%-32px)]" style={{
          ...
          <div className="flex flex-col gap-2">
            <button onClick={startTour} className="py-[11px] px-0 rounded-[10px] text-sm font-semibold border-none cursor-pointer font-[inherit] w-full" style={{ background: accent, color: "#fff" }}>Show me</button>
            <button onClick={finish} className="py-[9px] px-0 rounded-[10px] text-[13px] font-medium bg-transparent border-none cursor-pointer font-[inherit]" style={{ color: skipC }}>I know how</button>
          </div>
        </div>
      )}
        ...
        <div data-tour-tooltip className="fixed z-[101] left-1/2 rounded-[14px] py-[18px] px-5 max-w-[340px] w-[calc(100%-32px)]" style={{
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button onClick={finish} className="bg-transparent border-none text-[11px] font-medium cursor-pointer font-[inherit] p-0" style={{ color: skipC }}>Skip</button>
              <button onClick={next} className="py-[7px] px-5 rounded-[7px] text-xs font-semibold border-none cursor-pointer font-[inherit]" style={{ background: accent, color: "#fff" }}>

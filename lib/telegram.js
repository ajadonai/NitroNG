...
const TOPICS = { revenue: 2, orders: 3, users: 4, system: 5, timeout: 229, pulse: 101 };
...
export function tgDripTimeout(orderId, batch, detail) {
...
export function tgDigest(date, time, s) {
  send('pulse', [
    ...
    `💵 Deposits: <b>${s.deposits}</b>${s.depositsPct}`,

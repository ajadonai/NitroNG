...
const OUTREACH_TOPICS = { day1: 8, day3: 9, day7: 10, winback: 11, firstDeposit: 13, firstOrder: 14, summary: 400 };
...
export async function tgOutreach(users, touchKey, { label, creditMap } = {}) {
  ...
  for (let i = 0; i < total; i++) {
    ...
    const buttons = [
      [{ text: 'Reached', callback_data: `r:${u.id}` }, { text: 'No answer', callback_data: `na:${u.id}` }, { text: 'DNC', callback_data: `dnc:${u.id}` }],
    ];

...
export const PLATFORM_SLUGS = {
  ...
  Twitch: 'twitch',
  Discord: 'discord',
  // Added 16 Sep 2026. The landing page claims 31 platforms and only eleven
  // were crawlable, so the claim had no evidence behind it. These four were
  // picked on depth rather than count: each has curated groups and real
  // full-list volume, and thin pages across every remaining tile would be
  // doorway pages, which Google treats worse than no page at all.
  WhatsApp: 'whatsapp',
  Audiomack: 'audiomack',
  Boomplay: 'boomplay',
  Google: 'google',
  // Added 17 Sep 2026, on the same bar: two or more curated groups behind the
  // page. Threads clears it by more than any of the four above — ten groups,
  // four of them Nigerian-targeted. Twelve other tiles were measured and did
  // not clear it; nine have no curated group at all and exist only in the full
  // list, so a page for them would point at a search box. They came off the
  // shelf rather than getting a thin page.
  Threads: 'threads',
  Kick: 'kick',

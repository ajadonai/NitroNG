...
<tr><td align="center" class="em-shell" style="padding:14px 16px 16px;">
  ...
  <table cellpadding="0" cellspacing="0" border="0" style="max-width:520px;width:100%;"><tr>
    <td align="center" style="padding:18px 0 0;">
      <p style="font-size:11px;color:#b5b0aa;margin:0;line-height:1.6;">You received this because you have a Nitro account.<br/><a href="https://nitro.ng/dashboard?page=settings#set-notifications" style="color:${accent};">Manage preferences</a></p>
    </td>
  </tr></table>

...
export async function gradualDeliveryAnnouncementEmail(name) {
  return await emailWrap({
    ...
    body: `
      <p class="em-t" style="font-size:15px;line-height:1.7;color:#555;margin:0 0 6px;">Hi ${name},</p>
      <div style="height:12px;"></div>
      <p class="em-t" style="font-size:15px;line-height:1.7;color:#555;margin:0 0 22px;">Hope you're having a good weekend.</p>
      <p class="em-t" style="font-size:15px;line-height:1.7;color:#555;margin:0 0 22px;">Quick update: we've changed how orders are delivered on Nitro. Instead of everything arriving at once, your orders now come in gradually throughout the day. This makes your growth look more natural and keeps your account safer.</p>
      <p class="em-t" style="font-size:15px;line-height:1.7;color:#555;margin:0 0 28px;">It means delivery takes a few hours instead of minutes, but you can track everything in real time on your dashboard, including an estimated delivery time on each order.</p>
      ${emailCTA('https://nitro.ng/dashboard', 'Go to your dashboard')}
      <p class="em-m" style="font-size:13px;color:#999;margin:20px 0 0;text-align:center;">If anything looks off, tap Support in your dashboard and we'll sort it out.</p>

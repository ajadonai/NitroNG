...
export const DEAD_STATES = DEAD_ORDER_STATES;
...
// The ledger held one 'Refund' and a handful of other odd-cased or legacy
// types until 13 Sep 2026, when they were normalised in place; every reader
// can spell the type one way again.
const REFUND_WHERE = { type: 'refund', status: 'Completed' };

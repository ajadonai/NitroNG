...
// `active` is the selection gate for the picker. Only naira is on. The other
// four carry a "Soon" tag in the picker instead of a tick, which is what
// `active: false` buys: canDisplay() returns false, so LanguageOptions and
// CurrencyOptions render the Soon branch rather than a selectable row.
//
// The maths and the cross rates work — this is a product gate, not a broken
// conversion, and flipping a line back to true is all it takes to ship one.
...
export const CURRENCIES = {
  ...
  USD: { code: "USD", symbol: "$", name: "US Dollar", decimals: 2, active: false },

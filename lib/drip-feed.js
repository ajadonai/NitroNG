...
const DRIP_CONFIG = {
  followers:  { batchSize: 500,  intervalHours: 2, threshold: 500 },
  views:      { batchSize: 5000, intervalHours: 1, threshold: 5000 },
  likes:      { batchSize: 500,  intervalHours: 1, threshold: 500 },
  comments:   { batchSize: 50,   intervalHours: 0.5, threshold: 50 },
  plays:      null,
  engagement: { batchSize: 1500, intervalHours: 1, threshold: 1500 },
  reviews:    { batchSize: 10,   intervalHours: 2, threshold: 10 },
};

const DEFAULT_CONFIG = { batchSize: 500, intervalHours: 2, threshold: 500 };

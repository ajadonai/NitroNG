...
// Supports: MTP (MoreThanPanel), DaoSMM
//
// JustAnotherPanel was removed on 16 Sep 2026. It was never adopted properly —
// 22 orders in its whole life against MTP's 6,050 — and the 14 curated tiers
// that blocked its removal are down to zero enabled. Its 6,023 service rows
// stay in the table because 22 historical orders point at them, but they are
// marked unlisted so nothing can surface or reprice them, and nothing here can
// reach the panel any more. PROVIDER_IDS is the list: anything enumerating
// providers should read it rather than writing the three out by hand.
 ...
 * @param {string} providerId - 'mtp' | 'dao'

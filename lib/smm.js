...
export function placeOrder(providerId = 'mtp', serviceId, link, quantity, extra = {}) {
  ...
  // Web-traffic targeting. These were computed, stored on the order and handed
  // to this function, but never added to the payload — so every traffic order
  // reached the provider with a blank country and was rejected, whatever code
  // the customer chose.

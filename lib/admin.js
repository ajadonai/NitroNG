...
const ROLE_PAGES = {
  owner: '*',
  superadmin: '*',
  admin: ['overview', 'orders', 'users', 'leaderboard', 'menu-builder', 'services', 'pricing', 'price-changes', 'blog', 'alerts', 'rewards', 'finance', 'activity', 'promotions', 'acquisition', 'issues', 'crew', 'changelog', 'notifications', 'tasks', 'outreach', 'refills'],
...
const ROLE_WRITE_PAGES = {
  owner: '*',
  superadmin: '*',
  admin: ['orders', 'users', 'menu-builder', 'services', 'pricing', 'blog', 'alerts', 'rewards', 'leaderboard', 'activity', 'promotions', 'issues', 'crew', 'changelog', 'tasks', 'outreach', 'refills'],
  support: ['orders'],
  finance: ['orders'],
  staff: ['orders'],
};

...
const ROLE_PAGES = {
  owner: '*',
  superadmin: '*',
  admin: ['overview', 'orders', 'users', 'leaderboard', 'tickets', 'menu-builder', 'services', 'pricing', 'blog', 'alerts', 'rewards', 'finance', 'activity', 'promotions', 'acquisition', 'issues'],
...
const ROLE_WRITE_PAGES = {
  owner: '*',
  superadmin: '*',
  admin: ['orders', 'users', 'tickets', 'menu-builder', 'services', 'pricing', 'blog', 'alerts', 'rewards', 'leaderboard', 'activity', 'promotions', 'issues'],

...
const rewards = {
  status: {
    key: "boost",
    name: "Boost",
    eligibleSpend: 2430000,
    currentMin: 1500000,
    nextName: "Surge",
    nextMin: 7500000,
    remainingToNext: 5070000,
    progressPct: 32.4,
    discountPct: 1,
    pointEarnPct: 1.25
  },
...
The tier ladder is currently local in `STATUS_TIERS` inside `components/rewards.jsx`, not inside the `rewards` object.
...
|---|---:|
| Spark | ₦0 – ₦399,999 |
| Pulse | ₦400,000 – ₦1,499,999 |
| Boost | ₦1,500,000 – ₦7,499,999 |
| Surge | ₦7,500,000 – ₦37,499,999 |
| Apex | ₦37,500,000 – ₦74,999,999 |
| Legend | ₦75,000,000+ |
...
Pulse    ₦400k+       0.5% off    1% points
Boost    ₦1.5m+       1% off      1.25% points   Current
Surge    ₦7.5m+       2% off      1.5% points
Apex     ₦37.5m+      3% off      1.75% points
Legend   ₦75m+        4% off      2% points
```
...
The current UI keeps the tier ladder in `STATUS_TIERS`, exported from `components/rewards.jsx`.

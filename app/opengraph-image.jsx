    ...
    (
      <div
        style={{
          ...
          background: 'linear-gradient(135deg, #0a0d18 0%, #111627 50%, #0e1122 100%)',
      ...
      >
        ...
        <div
          style={{
            ...
            height: 500,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(196,125,142,0.12) 0%, transparent 70%)',
            display: 'flex',
          }}
        />
        ...
        <div
          style={{
            ...
            right: 0,
            height: 4,
            background: 'linear-gradient(90deg, transparent, #c47d8e, transparent)',
            display: 'flex',
          }}
        />
      </div>

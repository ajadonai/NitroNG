...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "What's the minimum to get started?", acceptedAnswer: { "@type": "Answer", text: "You can start with as little as ₦1,000. Flexible budgets, no minimums per campaign." }},
    { "@type": "Question", name: "How much do services cost?", acceptedAnswer: { "@type": "Answer", text: "Prices start as low as ₦20/1,000 for TikTok likes and ₦87/1,000 for Instagram followers. YouTube views start from ₦16/1,000, X followers from ₦109/1,000, and Facebook likes from ₦620/1,000. Every service has Budget (no refill), Standard (30-day refill), and Premium (lifetime refill) tiers. Check the pricing page for full details." }},

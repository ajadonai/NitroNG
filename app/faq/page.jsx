...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "What is Nitro?", acceptedAnswer: { "@type": "Answer", text: "Nitro is Nigeria's fastest social media growth platform. We help creators, businesses, agencies, and marketers grow their social media presence across 35+ platforms. Everything is in Naira with instant delivery." }},
    { "@type": "Question", name: "Why is Nitro better than other platforms?", acceptedAnswer: { "@type": "Answer", text: "Nitro was built specifically for the Nigerian market, not a generic template. Our dashboard is designed for speed and clarity. Place orders in seconds, track delivery in real time, and manage everything from one clean interface. Naira pricing with no USD conversion, automatic refunds for failed orders, 3 quality tiers (Budget, Standard, Premium), and 24/7 support. Most orders start delivering within minutes." }},
